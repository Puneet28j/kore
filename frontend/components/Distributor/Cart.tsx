    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 animate-in fade-in duration-500">
      ...
      <div className="space-y-4">
        <div className="bg-slate-900 text-white px-6 py-8 rounded-2xl shadow-lg">
          ...
          <button
            onClick={onCheckout}
            className="w-full bg-white text-slate-900 py-3 rounded-xl font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-slate-100 transition-all active:scale-95 group"
          >
            Confirm Order
