...
exports.create = async (req, res) => {
  try { return created(res, { message: "Unit created", data: await service.create(req.body) }); }
...
exports.update = async (req, res) => {
  try { return ok(res, { message: "Unit updated", data: await service.update(req.params.id, req.body) }); }
  catch (e) { return fail(res, { status: e.statusCode || 500, message: e.message }); }
};

exports.remove = async (req, res) => {
  try { await service.softDelete(req.params.id); return ok(res, { message: "Unit deleted" }); }
  catch (e) { return fail(res, { status: e.statusCode || 500, message: e.message }); }
};